...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('proof', models.FileField(null=True, upload_to=users.models.profile.get_proof_path)),
                ('profile_pic', models.ImageField(null=True, upload_to=users.models.profile.get_profile_pic_path)),
                ('profile_thumb', models.ImageField(null=True, upload_to=users.models.profile.get_profile_thumb_path)),
