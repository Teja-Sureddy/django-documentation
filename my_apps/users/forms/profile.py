...
class ProfilePicForm(ModelForm):
    ...
    def as_div(self):
        profile_src = self.instance.profile_pic.url if (self.instance and self.instance.profile_pic) else '/assets/public/default_pic.jpg'
        html = ''
        for field in self:
            html += f'''
...
class ProofForm(ModelForm):
    ...
    def as_div(self):
        proof_href = self.instance.proof.url if (self.instance and self.instance.proof) else None
        html = ''
        for field in self:
            html += f'''
